...
export const questions: Question[] = [
  ...
  },
  {
    id: 6,
    theme: "Écologie",
    text: "L'été, il fait trop chaud : je veux un plan massif de végétalisation pour rendre l'air de Blagnac respirable.",
    details: "Plan 'Ville Respirable' : végétalisation massive pour lutter contre les îlots de chaleur."
  },
  // --- SOCIAL ---
  {
    id: 7,
